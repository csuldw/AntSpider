...
) ENGINE=InnoDB AUTO_INCREMENT=3033619 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Table structure for comments_0902
-- ----------------------------
DROP TABLE IF EXISTS `comments_0902`;
CREATE TABLE `comments_0902` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `douban_id` int(10) unsigned NOT NULL DEFAULT '0',
  `douban_comment_id` int(10) unsigned NOT NULL DEFAULT '0',
  `douban_user_nickname` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  KEY `comments_douban_id_index` (`douban_id`),
  KEY `comments_douban_comment_id_index` (`douban_comment_id`)
) ENGINE=InnoDB AUTO_INCREMENT=598607 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ----------------------------
-- Table structure for movies_bak
-- ----------------------------
DROP TABLE IF EXISTS `movies_bak`;
CREATE TABLE `movies_bak` (
  ...
  KEY `movies_imdb_id_index` (`imdb_id`),
  KEY `movies_douban_id_index` (`douban_id`)
) ENGINE=InnoDB AUTO_INCREMENT=145808 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=83999 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `proxys` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11333 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
