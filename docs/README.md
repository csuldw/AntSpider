...
样例数据每个文件1000条数据，下载地址：[moviedata_small.tar.gz](http://moviedata.csuldw.com/dataset/moviedata_small.tar.gz)。完整的数据集有1G+，需要的用户可以点击后面的连接进行下载：[moviedata-10m.tar.gz](https://pan.baidu.com/s/1RxtClow1gNsYzqEQ3CCOJw)，密码获取方式如下(不定期更换): 
